...
public class AggregatedLinkResource extends ApertureServerResource {
  ...
  @Inject
  public AggregatedLinkResource(
      FL_ClusteringDataAccess clusterAccess, ClusterContextCache contextCache) {
    ...
    try {
      ...
      links =
          clusterAccess.getFlowAggregation(
              srcEntities, dstEntities, direction, dateRange, srcContextId, dstContextId);
