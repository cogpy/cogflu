...
public class QuBEClient extends RestClient implements FL_PatternSearch {
  ...
  public Object searchByExample(
    ...
    try {
      ...
      //			form.add("example", "{\"uid\":\"PD0\",\"name\":\"Pattern Descriptor
      ...
      // TODO add code to return an FL_Future object(if required) so that getResults() works; see
      // PatternSearchResource
