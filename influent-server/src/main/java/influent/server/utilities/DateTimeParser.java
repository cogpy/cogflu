...
public class DateTimeParser {
  ...
  /**
   * @see
   *     http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html#parse(java.lang.String)
   */
  public static DateTime parse(String str) {
    ...
    return new DateTime(
        d.getYear(), d.getMonthOfYear(), d.getDayOfMonth(), 0, 0, 0, DateTimeZone.UTC);
  }
  ...
  public static Period normalize(Period period) {
    ...
    Period result =
        new Period(
            millis,
            DateTimeUtils.getPeriodType(PeriodType.standard()),
