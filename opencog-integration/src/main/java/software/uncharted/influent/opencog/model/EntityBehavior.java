...
public class EntityBehavior {
    ...
    public EntityBehavior(String entityId, double cognitiveScore, double attentionLevel,
                         int relationshipCount, List<String> behavioralPatterns) {
    ...
    public double getCognitiveScore() { return cognitiveScore; }
    public double getAttentionLevel() { return attentionLevel; }
    public int getRelationshipCount() { return relationshipCount; }
    public List<String> getBehavioralPatterns() { return behavioralPatterns; }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(entityId, cognitiveScore, attentionLevel, relationshipCount, behavioralPatterns);
    }
}