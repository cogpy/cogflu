...
public class CognitiveAnalysisStatistics {
  ...
  public CognitiveAnalysisStatistics(
      int entityCount, int relationshipMapCount, int totalRelationships, long lastAnalysisTime) {
  ...
  public int getRelationshipMapCount() {
    return relationshipMapCount;
  }
