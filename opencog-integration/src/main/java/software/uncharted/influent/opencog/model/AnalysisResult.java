...
public class AnalysisResult {
  ...
  public AnalysisResult(
      List<CognitivePattern> patterns,
  ...
  public List<CognitivePattern> getPatterns() {
    return patterns;
  }
  ...
  public java.util.Map<String, EntityBehavior> getBehaviors() {
    return behaviors;
  }

  public List<CognitiveInsight> getInsights() {
    return insights;
  }
