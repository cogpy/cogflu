 ...
 *
 * <p>This class provides a hypergraph-based representation of financial entities and their
...
public class AtomSpaceBridge {
  ...
  public String createRelationship(
      String predicate, String fromEntity, String toEntity, double strength) {
    try {
      Map<String, Object> params = new HashMap<>();
      params.put("predicate", predicate);
