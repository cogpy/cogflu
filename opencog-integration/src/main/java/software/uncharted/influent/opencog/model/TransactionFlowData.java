...
public class TransactionFlowData {
    ...
    public TransactionFlowData(List<TransactionEntity> entities, List<Transaction> transactions, LocalDateTime analysisWindow) {
        this.entities = entities;
        this.transactions = transactions;
        this.analysisWindow = analysisWindow;
    }
    
    public List<TransactionEntity> getEntities() { return entities; }
    public List<Transaction> getTransactions() { return transactions; }
    public LocalDateTime getAnalysisWindow() { return analysisWindow; }
